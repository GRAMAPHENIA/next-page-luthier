...
const Modal = ({ guitar, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black backdrop-blur-lg  bg-opacity-80 z-50">
  ...
  return (
    <>
      <section
        ...
        onClick={openModal}
      >
        <figure className="overflow-hidden relative max-w-sm mx-auto ring-1 ring-black/5 rounded-xl flex items-center hover:text-[var(--text-extra-light)] bg-[var(--secondary)] hover:bg-[var(--hover-button)] cursor-pointer border border-white/10">
          <Image

  ...
  return (
    <>
      <section className="w-full grid lg:grid-cols-4 my-2 gap-2" id="sobremi">
        <figure className="flex flex-col align-middle items-center justify-center  lg:col-start-1 lg:col-end-5 bg-[#14181b] rounded-2xl w-full p-20">
          <Image
            width={150}
            height={150}
            src={Isotipo}
            ...
            className="px-4 pb-4"
          ></Image>
          <p className="text-center lg:text-2xl font-extralight text-[#7d8c9d] mb-10 mx-10 lg:mx-40 ">

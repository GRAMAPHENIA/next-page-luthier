  ...
  return (
    <>
      <section className="grid my-2 grid-cols-4 lg:grid lg:grid-cols-6 gap-2 object-contain">
        <figure className="bg-[#14181b] rounded-2xl col-span-6 p-4 ">
          <Image
            src={uno}
        ...
        <figure className="bg-[#14181b] rounded-2xl col-span-2 p-4">
          <Image
            src={tres}
            alt="Imagen del taller de lutheria"
            width={1000}
        ...
        <figure className="bg-[#14181b] rounded-2xl col-span-2 lg:flex justify-center align-middle p-4 hidden">
          <Image
            src={siete}
            alt="Imagen del taller de lutheria"
            width={1000}
